...
if ( ! class_exists( 'LMS_Education_Study_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class LMS_Education_Study_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new LMS_Education_Study_WPTT_WebFont_Loader( $url );
