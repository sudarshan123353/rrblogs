...
class LMS_Education_Study_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function lms_education_study_loadClassLoader($class)
    {
    ...
    public static function lms_education_study_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
