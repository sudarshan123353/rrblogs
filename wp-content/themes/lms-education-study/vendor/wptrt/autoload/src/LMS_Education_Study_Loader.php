...
class LMS_Education_Study_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function lms_education_study_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function lms_education_study_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function lms_education_study_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function lms_education_study_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->lms_education_study_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function lms_education_study_load( $class ) {
